...
*/
  ...
  const { totalConcepts, totalObjects, totalAttributes, density, averageStability } = metrics;
  ...
  safeSet('total-concepts', totalConcepts);
  safeSet('total-objects', totalObjects);
  safeSet('total-attributes', totalAttributes);
  safeSet('lattice-density', density);
  safeSet('lattice-stability', averageStability);
}
